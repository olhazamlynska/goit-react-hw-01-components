...
import { TransactionTable,TransactionHeaderTr,TransactionHeader, TransactionData, TransactionRow } from './TransactionHistiry.styled'

export const TransactionHistory = ({ items } )=>{
   return <div><TransactionTable>
  <thead>
    <TransactionHeaderTr>
